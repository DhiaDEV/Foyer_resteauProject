 ...
 */
final class Version20241220091850 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE demande_plat (id INT AUTO_INCREMENT NOT NULL, plat_id INT NOT NULL, user_id INT NOT NULL, date_demande DATETIME NOT NULL, description VARCHAR(255) DEFAULT NULL, nom VARCHAR(255) DEFAULT NULL, prenom VARCHAR(255) DEFAULT NULL, telephone INT DEFAULT NULL, email VARCHAR(255) NOT NULL, status VARCHAR(20) NOT NULL, created_at DATETIME DEFAULT NULL, INDEX IDX_479DD0D2D73DB560 (plat_id), INDEX IDX_479DD0D2A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE equipement (id_equipement_b INT AUTO_INCREMENT NOT NULL, chambre_id INT DEFAULT NULL, nom_equipement_b VARCHAR(100) NOT NULL, etat_equipement_b VARCHAR(50) NOT NULL, image VARCHAR(255) DEFAULT NULL, date_dernier_entretien_equipement_b DATE NOT NULL, rating INT DEFAULT NULL, INDEX IDX_B8B4C6F39B177F54 (chambre_id), PRIMARY KEY(id_equipement_b)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE plat (id INT AUTO_INCREMENT NOT NULL, categorie_plat_id INT DEFAULT NULL, nom_plat VARCHAR(255) DEFAULT NULL, desc_plat LONGTEXT DEFAULT NULL, prix_plat DOUBLE PRECISION NOT NULL, type_cuisine VARCHAR(255) NOT NULL, dispo_plat TINYINT(1) NOT NULL, image VARCHAR(255) DEFAULT NULL, quantite INT NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_2038A20788BE1BC2 (categorie_plat_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
